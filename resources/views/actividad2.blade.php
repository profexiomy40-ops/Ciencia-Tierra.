        ...
        <section class="schema-workbench" data-dnd>
            <div class="schema-bank">
                <div class="schema-bank-head">
                    ...
                    <p>Elige una tarjeta y colócala en cualquier casilla libre de su grupo: estados, factores o ejemplos.</p>
                </div>
                <div class="schema-token-grid">
                    <button class="token schema-token token-sky" draggable="true" data-token="solido" data-group="estados" data-label="Solido">
                    ...
                    <button class="token schema-token token-mint" draggable="true" data-token="liquido" data-group="estados" data-label="Liquido">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
                    ...
                    <button class="token schema-token token-green" draggable="true" data-token="gas" data-group="estados" data-label="Vapor">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
                    ...
                    <button class="token schema-token token-yellow" draggable="true" data-token="temperatura" data-group="factores" data-label="Temperatura">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
                    ...
                    <button class="token schema-token token-blue" draggable="true" data-token="fuerza" data-group="factores" data-label="Fuerza">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
                    ...
                    <button class="token schema-token token-coral" draggable="true" data-token="humedad" data-group="factores" data-label="Humedad">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
                    ...
                    <button class="token schema-token token-lime" draggable="true" data-token="gelatina" data-group="ejemplos" data-label="Gelatina">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
                    ...
                    <button class="token schema-token token-violet" draggable="true" data-token="plastilina" data-group="ejemplos" data-label="Plastilina">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
                    ...
                    <button class="token schema-token token-yellow" draggable="true" data-token="luz" data-group="factores" data-label="Luz">
                        <svg viewBox="0 0 64 64" class="token-art" aria-hidden="true">
            ...
            <div class="schema-map">
                ...
                <div class="schema-columns">
                    <section class="schema-group">
                        ...
                        <div class="dropzone schema-dropzone" data-dropzone="solido" data-drop-group="estados">
                            <span>Cuadro 1</span>
                            <small>Arrastra aqui</small>
                        </div>
                        <div class="dropzone schema-dropzone" data-dropzone="liquido" data-drop-group="estados">
                            <span>Cuadro 2</span>
                            <small>Arrastra aqui</small>
                        </div>
                        <div class="dropzone schema-dropzone" data-dropzone="gas" data-drop-group="estados">
                            <span>Cuadro 3</span>
                            <small>Arrastra aqui</small>
                        </div>
                    </section>
                    ...
                    <section class="schema-group">
                        ...
                        <div class="schema-factor-grid">
                            <div class="dropzone schema-dropzone small-zone" data-dropzone="temperatura" data-drop-group="factores">
                                <span>Cuadro 4</span>
                                <small>Arrastra aqui</small>
                            </div>
                            <div class="dropzone schema-dropzone small-zone" data-dropzone="fuerza" data-drop-group="factores">
                                <span>Cuadro 5</span>
                                <small>Arrastra aqui</small>
                            </div>
                            <div class="dropzone schema-dropzone small-zone" data-dropzone="humedad" data-drop-group="factores">
                                <span>Cuadro 6</span>
                                <small>Arrastra aqui</small>
                            </div>
                            <div class="dropzone schema-dropzone small-zone" data-dropzone="luz" data-drop-group="factores">
                                <span>Cuadro 7</span>
                                <small>Arrastra aqui</small>
                            </div>
                        </div>
                    ...
                    <section class="schema-group">
                        <div class="schema-group-head">
                            ...
                            <h3>Ejemplos de la materia</h3>
                        </div>
                        <div class="dropzone schema-dropzone" data-dropzone="gelatina" data-drop-group="ejemplos">
                            <span>Cuadro 8</span>
                            <small>Arrastra aqui</small>
                        </div>
                        <div class="dropzone schema-dropzone" data-dropzone="plastilina" data-drop-group="ejemplos">
                            <span>Cuadro 9</span>
                            <small>Arrastra aqui</small>
                        </div>
                    </section>
                ...
                <div class="schema-feedback drag-feedback" aria-live="polite">
                    Arrastra una tarjeta a cualquier casilla libre de su grupo para comenzar.
                </div>
            </div>
        </section>
