    ...
    <main>
        ...
        <section class="section roadmap guide-roadmap" id="ruta" aria-labelledby="ruta-title">
            ...
            <div class="roadmap-track">
                <article><span>1</span><h3>Introducción</h3><p>Una pregunta sencilla despierta las ideas previas sobre los materiales.</p></article>
                <article><span>2</span><h3>Objetivos</h3><p>Se presentan las metas: observar, clasificar y explicar los cambios.</p></article>
                ...
                <div class="video-card video-card-vivid">
                    <div class="video-screen">
                        ...
                        <div class="youtube-frame">
                            <iframe src="https://www.youtube-nocookie.com/embed/huVPSc9X61E?rel=0" title="Estados de la materia para niños" loading="lazy" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                        <a class="video-action" href="https://www.youtube.com/watch?v=huVPSc9X61E" target="_blank" rel="noreferrer">Abrir en YouTube</a>
                    </div>
                </div>
            </div>
        ...
        <section class="section objectives guide-objectives" id="objetivos" aria-labelledby="objetivos-title">
            ...
            <div class="objective-list">
                <article>1. Distinguir el estado inicial y el estado final en un proceso.</article>
                <article>2. Describir los efectos de temperatura, luz, humedad y fuerza.</article>
